    ...
    TagsMaterialize.prototype = {
        ...
        */
        add : function (item, dontPushVal, options)
        {
            ...
            // add a tag element
            var $tag = $('<span class="tagSelected ' + htmlEncode(tagClass) + (itemTitle !== null ? ('" title="' + itemTitle) : '') + '">' + htmlEncode(itemText) + '<i class="material-icons" data-role="remove">close</i></span>');
            $tag.data('item', item);
